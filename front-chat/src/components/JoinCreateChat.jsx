...
import chatIcon from "../assets/mk.png";
...
const JoinCreateChat = () => {
  ...
  return (
    ...
    backgroundRepeat: "no-repeat",
      ...
      <div className="p-10 dark:w-full flex flex-col gap-5 max-w-md rounded bg-black/60 shadow">
        <div>
          <img src={'https://www.campixx.de/wp-content/uploads/2023/02/chatx-logo-campixx-t.png'} className="w-44 mx-auto" />
        </div>
