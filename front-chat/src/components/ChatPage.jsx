...
const ChatPage = () => {
  ...
  console.log("SUBSCRIBING:", currentUser);
    ...
    <div className="">
      ...
      <main
        ...
        className="py-20 px-10   w-2/3 dark:bg-slate-600 mx-auto h-screen overflow-auto "
          style={{
    backgroundImage:
      "url('https://wallpaperaccess.com/full/17602.jpg')",
      ...
      >
        {messages.map((message, index) => (
          ...
          >
            <div
              className={`my-2 ${
                message.sender === currentUser ? "bg-green-500/60" : "bg-gray-500/50"
              } p-2 max-w-xs rounded`}
            >
              <div className="flex flex-row gap-2">
                <img
                  className="h-10 w-10"
                  src={`https://picsum.photos/seed/${message.sender}/100`}
                  alt=""
                />
